...
def test_command_line_interface():
    ...
    cgi_help_result = runner.invoke(querynator.__main__.querynator_cli, ["query-api-cgi"])
    ...
    civic_help_result = runner.invoke(querynator.__main__.querynator_cli, ["query-api-civic"])
