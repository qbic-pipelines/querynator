...
class testCLIHelp(unittest.TestCase):
    ...
    def test_commandLineInterface(self):
        """Test the CLI."""
        result = self.runner.invoke(querynator.__main__.querynator_cli)
        self.assertEqual(result.exit_code, 0)

    def test_helpMessage(self):
        """Test help message"""
        help_result = self.runner.invoke(querynator.__main__.querynator_cli, ["--help"])
    ...
    def test_CgiHelp(self):
        ...
        cgi_help_result = self.runner.invoke(querynator.__main__.querynator_cli, ["query-api-cgi", "--help"])
    ...
    def test_CivicHelp(self):
        ...
        civic_help_result = self.runner.invoke(querynator.__main__.querynator_cli, ["query-api-civic", "--help"])
    ...
    def test_CreatereportHelp(self):
        ...
        report_help_result = self.runner.invoke(querynator.__main__.querynator_cli, ["create-report", "--help"])
    ...
    def test_nonExistingSubcommand(self):
        ...
        result = self.runner.invoke(querynator.__main__.querynator_cli, ["query-api-clinvar"])
        self.assertEqual(result.exit_code, 2)
        self.assertIn("No such command", result.output)

    def test_nonExistingOption(self):
        """Test non-existing option"""
        result = self.runner.invoke(querynator.__main__.querynator_cli, ["query-api-cgi", "--baz"])
        self.assertEqual(result.exit_code, 2)
...
class testCliRun(unittest.TestCase):
    ...
    def test_queryApiCgi(self):
        ...
        result = self.runner.invoke(querynator.__main__.querynator_cli,
                                    ["query-api-cgi",
                                    "--mutations", f"{os.getcwd()}/example_files/example.vcf",
                                    "--genome", "GRCh37",
                                    "--outdir", outdir,
                                    "--cancer", "Breast adenocarcinoma",
                                    "--email", "dummy@internet.by",
    ...
    def test_createReport(self):
        ...
        result = self.runner.invoke(querynator.__main__.querynator_cli,
                                    ["create-report",
                                    "--cgi_path", f"{os.getcwd()}/example_files/cgi_test_out",
                                    "--civic_path", f"{os.getcwd()}/example_files/civic_test_out",
                                    "--outdir", outdir])
        self.assertEqual(result.exit_code, 0, "non-zero exit code")
